...
class SolicitudServicioController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('solicitudes.create', compact('clientes', 'servicios', 'usuarios'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'area_empresa'    => 'required|string|max:150',
        ...
        $data = $request->all();
        $data['id_usuario'] = $data['id_usuario'] ?? (auth()->id() ?? 1);
    ...
    public function edit(string $id)
    {
        ...
        $servicios = Servicio::where('estado', 'ACTIVO')->get();
        $usuarios = Usuario::all();
        return view('solicitudes.edit', compact('solicitud', 'clientes', 'servicios', 'usuarios'));
    }
