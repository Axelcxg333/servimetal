...
@section('title', 'Crear Servicio - SERVIMETAL')
@section('content')
    ...
    <div class="card-body">
        <form action="{{ route('servicios.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nombre_servicio') is-invalid @enderror" id="nombre_servicio" name="nombre_servicio" value="{{ old('nombre_servicio') }}" required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('precio_referencial') is-invalid @enderror" id="precio_referencial" name="precio_referencial" value="{{ old('precio_referencial') }}" step="0.01" min="0">
