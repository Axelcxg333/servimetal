...
<div class="d-flex justify-content-between align-items-center mb-1">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('usuarios.edit', $usuario->id_usuario) }}" class="btn-c-primary">
            <i class="fas fa-pen me-1"></i> Editar
        </a>
        <a href="{{ route('usuarios.index') }}" class="btn-c-light">
...
<div class="card-c" style="max-width: 760px;">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <span class="{{ $usuario->rol === 'ADMINISTRADOR' ? 'badge-soft-danger' : 'badge-soft-info' }}">{{ $usuario->rol }}</span>
        </div>
        <div class="col-md-6">
