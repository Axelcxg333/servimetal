...
@section('title', 'Crear Cliente - SERVIMETAL')
        ...
        <form action="{{ route('clientes.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nombre_razon_social') is-invalid @enderror" 
                       id="nombre_razon_social" name="nombre_razon_social" value="{{ old('nombre_razon_social') }}" required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('ruc_dni') is-invalid @enderror" 
                           id="ruc_dni" name="ruc_dni" value="{{ old('ruc_dni') }}" required>
